local Update = (loadstring(game:HttpGet("https://raw.githubusercontent.com/xZPUHigh/Storage/main/Update.lua")))();
local Alert = (loadstring(game:HttpGet("https://raw.githubusercontent.com/xZPUHigh/Storage/main/Alert.lua")))();
...
ServTab:Button("Server Hop", function()
	while wait() do
		local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/xZPUHigh/Storage/main/HopServers.lua")))();
